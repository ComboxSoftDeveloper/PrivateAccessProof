...
; PrivateAccessProof.Benchmarks.NumberBench.Direct()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFADB63FAE0]; PrivateAccessProof.Subjects.ReadNumberDirect(PrivateAccessProof.Types.Secret)
...
; PrivateAccessProof.Benchmarks.NumberBench.Reflection()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFADB66F9F0]; PrivateAccessProof.Subjects.ReadNumberReflection(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
...
M02_L17:
       mov       rcx,rdi
       call      qword ptr [7FFADB707168]; System.RuntimeTypeHandle.<InternalAllocNoChecks>g__InternalAllocNoChecksWorker|37_0(System.Runtime.CompilerServices.MethodTable*)
       mov       rbx,rax
...
M02_L27:
       mov       rcx,rbp
       mov       rdx,rsi
       call      qword ptr [7FFADB3066E8]; System.Buffer.MemmoveInternal(Byte ByRef, Byte ByRef, UIntPtr)
       jmp       near ptr M02_L04
M02_L28:
       mov       rcx,rdi
       mov       rdx,rsi
       call      qword ptr [7FFADB305878]; System.Runtime.CompilerServices.CastHelpers.Box_Nullable(System.Runtime.CompilerServices.MethodTable*, Byte ByRef)
       mov       rbx,rax
       jmp       near ptr M02_L04
       mov       rcx,[rbx+8]
       mov       rcx,[rcx+10]
...
M02_L33:
       ...
       call      qword ptr [7FFADB306328]; System.Runtime.CompilerServices.CastHelpers.ChkCastClass(Void*, System.Object)
       mov       r8,rax
       lea       r9,[rsp+28]
       mov       [rsp+20],r9
       mov       r9,[rbx+8]
...
M02_L34:
       ...
       jne       short M02_L36
M02_L35:
       call      qword ptr [7FFADB70D788]
       int       3
M02_L36:
       mov       rdx,[rbx+8]
       mov       rcx,rsi
       call      qword ptr [7FFADB70D7A0]
       int       3
M02_L37:
...
; System.Runtime.CompilerServices.CastHelpers.Unbox(System.Runtime.CompilerServices.MethodTable*, System.Object)
       ...
       ret
M03_L00:
       jmp       qword ptr [7FFADB70D5C0]; System.Runtime.CompilerServices.CastHelpers.Unbox_Helper(System.Runtime.CompilerServices.MethodTable*, System.Object)
...
; PrivateAccessProof.Benchmarks.NumberBench.Accessor()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFADB62FAC8]; PrivateAccessProof.Subjects.ReadNumberAccessor(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
...
; PrivateAccessProof.Benchmarks.NumberBench.Direct()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFAA3F8CF78]; PrivateAccessProof.Subjects.ReadNumberDirect(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
; PrivateAccessProof.Subjects.ReadNumberDirect(PrivateAccessProof.Types.Secret)
...
; PrivateAccessProof.Benchmarks.NumberBench.Reflection()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFAC052CCD8]; PrivateAccessProof.Subjects.ReadNumberReflection(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
; PrivateAccessProof.Subjects.ReadNumberReflection(PrivateAccessProof.Types.Secret)
       ...
       mov       rcx,1E1E5C04528
       mov       rcx,[rcx]
       call      qword ptr [7FFAC04475C0]; System.Reflection.RtFieldInfo.GetValue(System.Object)
       mov       rbx,rax
       mov       rdx,offset MT_System.Int32
       cmp       [rbx],rdx
       je        short M01_L00
       mov       rdx,rbx
       mov       rcx,offset MT_System.Int32
       call      qword ptr [7FFAC0124408]; System.Runtime.CompilerServices.CastHelpers.Unbox(Void*, System.Object)
M01_L00:
       mov       eax,[rbx+8]
       add       rsp,20
       pop       rbx
...
M02_L08:
       mov       rcx,rbx
       call      qword ptr [7FFAC0455EC0]; System.Reflection.RtFieldInfo.InitializeInvocationFlags()
       jmp       near ptr M02_L00
M02_L09:
       mov       rcx,rbx
       call      qword ptr [7FFAC0456088]; System.Reflection.RtFieldInfo.InitializeFieldType()
       mov       rdx,rax
       jmp       near ptr M02_L04
M02_L10:
       mov       rcx,rdi
       call      qword ptr [7FFAC0076658]; System.RuntimeType.InitializeCache()
       jmp       short M02_L06
M02_L11:
       mov       rcx,rdi
       call      qword ptr [7FFAC0076658]; System.RuntimeType.InitializeCache()
...
M02_L12:
       ...
       je        short M02_L14
       mov       rcx,rbx
       call      qword ptr [7FFAC0446E48]; Precode of System.Reflection.RuntimeFieldInfo.get_DeclaringType()
       mov       rcx,rax
       mov       rax,[rax]
       mov       rax,[rax+0B0]
       call      qword ptr [rax]
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FFAC0605500]
       mov       rdx,rax
       mov       rcx,rsi
       call      qword ptr [7FFAC02E6718]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
M02_L13:
       xor       edi,edi
...
M02_L15:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFAC060D998]
       mov       rdx,rax
       mov       rcx,rbx
       xor       r8d,r8d
       call      qword ptr [7FFAC03D5AB8]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
M02_L16:
       call      qword ptr [7FFAC0604768]
       mov       rbp,rax
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rdi,rax
       mov       rcx,rbx
       call      qword ptr [7FFAC0447570]
       mov       r14,rax
       mov       rbx,[rbx+10]
       mov       rcx,rsi
       ...
       mov       r8,rbx
       mov       rcx,rbp
       call      qword ptr [7FFAC0604078]
       mov       rdx,rax
       mov       rcx,rdi
       call      qword ptr [7FFAC012F708]
       mov       rcx,rdi
       call      CORINFO_HELP_THROW
M02_L17:
       call      qword ptr [7FFAC01243F0]; System.Runtime.CompilerServices.CastHelpers.ChkCastClassSpecial(Void*, System.Object)
       int       3
M02_L18:
       lea       rcx,[rsp+28]
       mov       [rsp+20],rcx
...
; PrivateAccessProof.Benchmarks.NumberBench.Accessor()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFAC050CF60]; PrivateAccessProof.Subjects.ReadNumberAccessor(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
; PrivateAccessProof.Subjects.ReadNumberAccessor(PrivateAccessProof.Types.Secret)
...
; PrivateAccessProof.Benchmarks.NumberBench.Direct()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFAD1D5EB80]; PrivateAccessProof.Subjects.ReadNumberDirect(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
; PrivateAccessProof.Subjects.ReadNumberDirect(PrivateAccessProof.Types.Secret)
...
; PrivateAccessProof.Benchmarks.NumberBench.Reflection()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFAD1D5EB98]; PrivateAccessProof.Subjects.ReadNumberReflection(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
; PrivateAccessProof.Subjects.ReadNumberReflection(PrivateAccessProof.Types.Secret)
...
M01_L03:
       ...
       mov       rcx,[rcx+10]
       cmp       [rcx],ecx
       call      qword ptr [7FFAD1BBCF18]; System.RuntimeType.get_IsNullableOfT()
       test      eax,eax
       jne       short M01_L06
       mov       dword ptr [rdi+20],0F
M01_L04:
...
M01_L07:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFAD1E4C918]
       mov       r8,rax
       mov       rcx,rbx
       xor       edx,edx
       call      qword ptr [7FFAD1E4C930]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
; Total bytes of code 288
...
M02_L02:
       ...
       mov       rcx,[rbx+8]
       cmp       [rcx],ecx
       call      qword ptr [7FFAD1D0F128]; Precode of System.Reflection.RuntimeFieldInfo.get_DeclaringType()
       test      rax,rax
       je        short M02_L03
       mov       rcx,[rbx+8]
       cmp       [rcx],ecx
...
M02_L04:
       mov       rcx,offset MT_System.RuntimeType
       call      qword ptr [7FFAD19A6190]; System.Runtime.CompilerServices.CastHelpers.ChkCastClass(Void*, System.Object)
       mov       rcx,rax
       cmp       [rcx],ecx
       call      qword ptr [7FFAD1BBCF18]; System.RuntimeType.get_IsNullableOfT()
       test      eax,eax
...
M02_L16:
       mov       rdx,[rbx+8]
       mov       rcx,rsi
       call      qword ptr [7FFAD1E4CAB0]
       int       3
M02_L17:
       call      qword ptr [7FFAD1E4CAC8]
       int       3
...
M04_L00:
       ...
       jne       short M04_L05
       mov       rcx,rbx
       call      qword ptr [7FFB183E2570]; System.RuntimeTypeHandle.GetCorElementType(System.RuntimeType)
       cmp       eax,1D
       ja        short M04_L01
       mov       ecx,1FEF7FFF
       bt        ecx,eax
...
; PrivateAccessProof.Benchmarks.NumberBench.Accessor()
       mov       rcx,[rcx+8]
       jmp       qword ptr [7FFAD1D7EB98]; PrivateAccessProof.Subjects.ReadNumberAccessor(PrivateAccessProof.Types.Secret)
; Total bytes of code 10
```
```assembly
; PrivateAccessProof.Subjects.ReadNumberAccessor(PrivateAccessProof.Types.Secret)
